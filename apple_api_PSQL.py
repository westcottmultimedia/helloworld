import sqlite3, csv, codecs, re, json, os, base64, time, hashlib, ssl, jwt, configparser, logging, psycopg2
...
REGIONS_MISSED_APPLE_MUSIC = ['co']
REGIONS_MISSED_ITUNES_SONGS = []
REGIONS_MISSED_ITUNES_ALBUMS = []
REGIONS_MISSED_MUSIC_VIDEOS = ['mn', 'zw', 'pg', 'tm', 'na', 'sz', 'ai', 'cv', 'tj', 'kg', 'kh', 'fm', 'fj', 'bf', 'la', 'mz', 'gm']
...
class TrackDatabase(object):
    ...
    def init_database(self):
        ...
        try:
            ...
            self.db = psycopg2.connect("dbname={} user=ericchen0121 password=123".format(PG_DB_NAME))
    ...
    def update_sales_stats(self, service_id, territory_id, media_id, media_type, position, date_str):
        ...
        stats_query = """
            INSERT INTO peak_sales_position
